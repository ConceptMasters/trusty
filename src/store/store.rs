...
pub trait Store: Send + Sync {
    ...
    async fn get_tenants(&self) -> Result<Vec<Tenant>, Error>;
    ...
    async fn get_users(&self, query: UserQuery) -> Result<Vec<User>, Error>;
    ...
    async fn get_roles(&self) -> Result<Vec<Role>, Error>;
}
